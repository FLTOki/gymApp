...
class AppColor{
  static Color homePageBackground = const Color(0xFFFFFF);
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFF6d8dea);
  ...
  static Color cicuitsColor = const Color(0xFF2f2f51);
